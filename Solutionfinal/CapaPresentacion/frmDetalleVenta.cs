    ...
    public partial class frmDetalleVenta : Form
    {
        ...
        private void LlenarGrid(){
            ...
            try
            {
                ...
                montoigv = calcularIgv();
                txtSubtotal.Text ="s/ "+ calcularSubtotal().ToString("0.00");
        ...
        {
            return Convert.ToDouble(subtotal / Convert.ToDouble("1," + igv));
        }

        double calcularIgv()
        {
           return  calcularSubtotal() * Convert.ToDouble("0," + igv);
        }
