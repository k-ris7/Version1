    ...
    public partial class frmProducto : Form
    {
        ...
        private void LlenarCombos()
        {
            try
            {
                ...
                cboProveedor.DataSource = negProveedor.Instancia.ListarProveedor();
        ...
        private void CargarGridProveedor()
        {
            try
            {
                ...
                pr = negProveedor.Instancia.ListarProveedor();
        ...
        private void btnGuardarPR_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int i = negProveedor.Instancia.MantenimientoProveedor(pr, tipoedicion);
                MessageBox.Show("¡Registro Correcto!", "Mensaje",
                                MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnEliminarPR_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (r == DialogResult.Yes)
                {
                    int i = negProveedor.Instancia.MantenimientoProveedor(pr, 3);
                    MessageBox.Show("Registro eliminado", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                ControlBotones("UM",true, false, false, false, false, true);
                ac.BloquearText(this.tbcUnidMedida, false);
        ...
        private void dgvProveedor_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                pr = negProveedor.Instancia.BuscarProveedor(id_Proveedor);
        ...
        private void tbcProducto_Click(object sender, EventArgs e)
        {

        }

        private void tbcProveedor_Click(object sender, EventArgs e)
        {
